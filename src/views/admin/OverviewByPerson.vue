<template>
    <v-container>
        ...
        <div class="mt-5">
            ...
            <v-skeleton-loader v-if="isLoading" type="table-thead, table-row@9" class="mx-6 mt-9"></v-skeleton-loader>
            ...
            <!-- **** STAVKE liste **** -->
            <v-card v-for="user in users" :key="user.id" class="pa-1 my-2" outlined v-if="!isLoading">
                <v-row>
                    <v-col cols="3" md="3">
