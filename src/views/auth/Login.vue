    ...
    <v-container blue lighten-5 fluid fill-height>
        <v-row align="center" class="">
            <v-col class="">
                            ...
                            <v-row>
                                ...
                                <v-col cols="10" class="mb-2 mx-auto">
                                    <v-text-field v-model="password" :append-icon="showPassword ? 'mdi-eye' : 'mdi-eye-off'"
                                        ...
                                        name="input-10-1" label="Lozinka" counter
                                        @click:append="showPassword = !showPassword"></v-text-field>
                                </v-col>
                                <!--Login btn -->
                                <v-col cols="10" class="mx-auto">
                                    <v-btn block class="primary" :disabled="!valid" @click="login">
                                        Prijava
                                    </v-btn>
                                </v-col>
                            </v-row>
                ...
                <p class="text-center body-2 mt-5">Zaboravili ste lozinku? <router-link to="/resetiranje-lozinke"
                        class="rm-underline">Resetiranje lozinke</router-link> </p>
            </v-col>
        </v-row>
    </v-container>
</template>
